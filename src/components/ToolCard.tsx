    ...
    <div
      ...
      className={`group relative p-6 cursor-pointer border-2 transition-all duration-200 flex flex-col justify-between select-none ${
        isDark 
          ...
          : 'bg-[#FFFFFF] text-[#000000] border-[#000000] hover:shadow-[6px_6px_0px_#000000]'
    ...
    >
      <div>
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 border-2 border-current flex items-center justify-center font-display text-sm tracking-tight bg-[#FF4D00] text-[#000000] flex-shrink-0">
      ...
      <div>
        ...
        <div className="flex items-center gap-2 pt-3 border-t border-white/20">
          <button
            onClick={() => onSelectTool(tool)}
            className="flex-1 py-2 px-3 border-2 border-white/20 hover:border-white text-white font-mono text-xs font-bold uppercase transition-colors text-center rounded-full"
          >
            DETAILS
          </button>
          ...
          <button
            ...
            className="flex-1 py-2 px-3 bg-[#FF4D00] hover:bg-white text-black font-display text-xs tracking-tight uppercase border-2 border-[#FF4D00] hover:border-white transition-all flex items-center justify-center gap-1.5 rounded-full"
          >
            <span>LAUNCH</span>
